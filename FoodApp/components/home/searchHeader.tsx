...
//
//     return (
//         <View className="flex-1 flex-row items-center mt-2" style={{zIndex : 10,elevation : 10,position: "relative"}}>
...
//                     <Pressable onPress={() => {router.push("/(home)/filter_page");console.log("filter pressed")}}>
//                         <Image
